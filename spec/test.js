...
describe('init state', function(){
  ...
  describe(':before', function(){
    it('defined', function() {      
      data = parser.getStates({}, 'default', ':transform move bottom 250px move left 0 :before test() :go value');
      assert.equal(':transform move bottom 250px move left 0', data.default[0].do);
